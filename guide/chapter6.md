...
$\L a:\Uz.\L b:\Uz.\L c:\Uz.\L x:a.\L y:b.x$
...
> 额外：你可以看看$@\inl\ @0\ @0\ \True\ \False\ \true$的类型是什么
...
在证明完not(1=2)后,解锁整数类型Z,同时获得成就"类型论版整数"

解锁Z的构造子和归纳类型ind_Z

$$
\S{f:\nat→\Z}\S{g:\Z→\nat}\P{n:\nat}\eqs{g(f\ n)}{n}\X (f\ 0=0\Z)
$$
